    ...
    <div class="panel-body paddingbottom0">
        <form class="form-horizontal" role="form">
			...
			<div class="form-group">
				<div class="col-md-3">
					<label class="control-label text-right">관리자구분</label>
				...
				<div class="col-md-3">
					...
					<input type="text" class="form-control input-xs" data-bind="value:$root.mngAreaName" disabled="disabled" style="ime-mode:inactive;">
				</div>
				<div class="col-md-3">
		...
		<div class="panel-body" data-bind="with: detailsVM">
			<div class="row" data-bind="with: data">
				<fieldset>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label class="col-md-4 control-label text-right" for="rolegroupCode">관리자 구분<span class="text-danger">*</span></label>
							<div class="col-md-8">
								<select class="form-control input-xs" name="rolegroupCode" data-bind="options: $root.appUserGradeSelectOptions, optionsText:'text', optionsValue:'value', value: rolegroupCode, optionsCaption: '선택', enable:$parent.isCreateMode()"></select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label text-right" for="mngAreaSeq">관제지역 선택<span data-bind="text:$parent.isRequiredForArea()" class="text-danger" ></span></label>
							<div class="col-md-8">
								<select class="form-control input-xs" name="mngAreaSeq" data-bind="options: $root.areaSelectOptions, optionsText:'text', optionsValue:'value', value: mngAreaSeq, optionsCaption: '선택', enable:false"></select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-md-4 control-label text-right" for="marketSeq">시장 선택<span data-bind="text:$parent.isRequiredForMarket()" id="market" class="text-danger"></span></label>
							<div class="col-md-8">
								<select class="form-control input-xs" name="marketSeq" data-bind="options: $root.marketSelectOptions, optionsText:'text', optionsValue:'value', value: marketSeq, optionsCaption: '선택', enable: rolegroupCode() =='MARKET_ADMIN'"></select>
							</div>
						</div>
...
<script type="text/javascript">
    setPageLocation("areasystem/adminmng", "관리자 관리");
...
<script type="text/javascript" src="${contextPath}/app/areasystem/adminmng/adminmng.js"></script>