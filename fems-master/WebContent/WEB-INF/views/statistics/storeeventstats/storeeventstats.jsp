...
<form id="detailsForm" class="form-horizontal" action="#" data-bind="visible: detailsVM.isEditMode" style="padding-top:40px;">
	<div class="panel panel-flat">
		<div class="panel-heading">
    		<h5><i class="icon-stats-bars2"></i><bold> 점포별 화재 신호 통계 </bold></h5>
      		<div class="heading-elements">
        		<ul class="icons-list">
          			<li><a data-action="collapse"></a></li>
        		</ul>
    ...
    <div class="panel-body" data-bind="with: detailsVM" >
        <div class=" form-group">
           <!-- 통계 상세 테이블  -->
           <div class=" text-nowrap col-md-6 col-sm-12 table-responsive">
                ...
                <col style="width: 30%">
                  ...
                  <tbody id="tbody" style="vertical-align: middle !important;">
                    <!-- ko foreach: data() -->
                    <tr>
...
<script type="text/javascript">
	setPageLocation("statistics/storeeventstats", "점포별 화재 신호 통계");
...
<script type="text/javascript" src="${contextPath}/app/statistics/storeeventstats/storeeventstats.js"></script>
