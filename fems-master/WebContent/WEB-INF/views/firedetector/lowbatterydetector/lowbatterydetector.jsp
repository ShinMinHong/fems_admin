...
<script type="text/javascript">
    setPageLocation("firedetector/lowbatterydetector", "배터리 잔량이 20% 미만인 화재 감지기 목록 조회");
...
<script type="text/javascript" src="${contextPath}/app/firedetector/lowbatterydetector/lowbatterydetector.js"></script>