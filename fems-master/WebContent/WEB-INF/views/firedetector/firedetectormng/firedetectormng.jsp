...
<script type="text/javascript">
    setPageLocation("firedetector/firedetectormng", "화재감지기 관리");
...
<script type="text/javascript" src="${contextPath}/app/firedetector/firedetectormng/firedetectormng.js"></script>