...
<div class="panel panel-flat">
	<div class="panel-heading">
		...
		<div style="margin-top:10px;" class="row">
			<div class="col-md-12">
						<ol>
							<li> 대상처관리자 정보를 대량등록 합니다.</li>
							<li> [샘플엑셀]을 다운로드 합니다.</li>
							<li> 다운받은 엑셀에 등록하려는 정보 입력합니다.</li>
							<li> 연락처는 휴대폰번호를 -(하이픈)포함하여 입력해야 합니다.</li>
...
<script type="text/javascript" src="${contextPath}/app/commonpopup/openkeeperexcelupload.js"></script>