 ...
 <div class="panel panel-flat">
	<div class="panel-heading">
		...
		<div style="margin-top:10px;" class="row">
			<div class="col-md-12">
						<ol>
							<li> 점포 SMS 수신대상 정보를 대량등록 합니다.</li>
							<li> [샘플엑셀]을 다운로드 합니다.</li>
							<li> 다운받은 엑셀에 등록하려는 정보 입력합니다.</li>
							<li> 점포고유번호,이름,휴대폰번호는 필수 입력사항입니다.</li>
							<li> SMS 수신여부는 Y,N 형식으로 입력해주세요. 미입력시 SMS수신으로 자동입력 됩니다.</li>
							<li> 같은 점포 내 핸드폰 번호 중복 입력은 허용되지 않습니다.</li>
...
<script type="text/javascript" src="${contextPath}/app/commonpopup/openstoresmsuserexcelupload.js"></script> 