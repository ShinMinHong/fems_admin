...
// 화재감지기 관리 (검색 , 리스트)
function NoSignalDetectorVM() {

	var self = this;
	self.clazz = "NoSignalDetectorVM";

	//Extend VM
	vmExtender.extendGridVM(self);

	//List API URL
	self.listURL = contextPath +"/firedetector/nosignaldetector/api/page.json";
	...
	self.excelDownload = function(){
		...
		var url = contextPath + "/firedetector/nosignaldetector/excel?";
