 ...
 */
function AbleKendoGridVM(elementId, url, columns, eventHandler, applySearchCondition, customGridOption) {
	var self = this;
	...
	var gridOption = customGridOption || {};
	...
	// 2021.01.26 SHH
	// Default pageSize : 20으로 변경
	var pageSize = ( _.contains(appconfig.allowPageSizeList, gridOption.pageSize) ) ? gridOption.pageSize : 20;
...
//				}
	...
	self.gridAuthWidthResize = function() {
		...
		if( !_.isEmpty(grid)) {
			...
			var authWidth = totalWidth - fixedWidth - scrollbarWidth - scrollbarWidth;
