 ...
 */
public class AbleEnumUtil {
	protected static Logger logger = LoggerFactory.getLogger(AbleEnumUtil.class);

	private AbleEnumUtil() { /**/ }
	...
	public static <E extends Enum<E>> Boolean isNotSet(E e) {
		...
		if(e instanceof AbleValueEnum<?>) {
			AbleValueEnum<?> et = (AbleValueEnum<?>)e;
			String value = (et.getValue() == null) ? "" : et.getValue().toString();
			return isNotSetValue(value) || isNotSetValue(stringValue);
		}
		return isNotSetValue(stringValue);
	}
	private static boolean isNotSetValue(String value) {
		return "NOT_SET".equals(value) || "NOTSET".equals(value) || "".equals(value);
	}
