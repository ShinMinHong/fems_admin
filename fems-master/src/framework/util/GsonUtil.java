...
public class GsonUtil {
     ...
     * @param classOfT 획득하려는 객체 클래스, generic, collection등은 미지원 TypeToken을 이용하여 처리가능
     */
    ...
    /**
     * 주어진 Json을 역직렬화하여 객체로 획득
     * @param typeOfT 획득하려는 객체 타입, Gson TypeToken을 이용하여 처리가능
     */
