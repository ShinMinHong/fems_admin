 ...
 *
 */
public class AbleLoginUrlAuthenticationEntryPoint implements AuthenticationEntryPoint, InitializingBean {
    //~ Static fields/initializers =====================================================================================

    private static final Logger logger = LoggerFactory.getLogger(AbleLoginUrlAuthenticationEntryPoint.class);
    ...
    private final RedirectStrategy redirectStrategy = new AbleRedirectStrategy();
     ...
     */
    public AbleLoginUrlAuthenticationEntryPoint(String loginFormUrl) {
