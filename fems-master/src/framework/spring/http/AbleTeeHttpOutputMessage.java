 ...
 */
public class AbleTeeHttpOutputMessage implements HttpOutputMessage {

	HttpOutputMessage httpOutputMessage;
	OutputStream customBodyStream;
	ByteArrayOutputStream baos;

	public AbleTeeHttpOutputMessage(HttpOutputMessage httpOutputMessage) throws IOException {
