 ...
 */
public class AbleHttpInputMessage implements HttpMessage, HttpInputMessage {
	 ...
	 */
	public AbleHttpInputMessage(HttpInputMessage httpInputMessage, InputStream customBody) {
