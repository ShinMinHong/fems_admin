 ...
 * @author ByeongDon
 */
public class AbleObjectMapper extends ObjectMapper  {
	private static final long serialVersionUID = 9103711369247336228L;

	protected static final Logger logger = LoggerFactory.getLogger(AbleObjectMapper.class);

	private transient ClassLoader moduleClassLoader = getClass().getClassLoader();

	private static final String DEFAULT_DATETIME_FORMAT = "yyyy-MM-dd'T'HH:mm:ss.SSSZ";

	public AbleObjectMapper() {
		this(null, DEFAULT_DATETIME_FORMAT);
	}

	public AbleObjectMapper(ApplicationContext applicationContext) {
		this(applicationContext, DEFAULT_DATETIME_FORMAT);
	}

	public AbleObjectMapper(String simpleDateTimeFormat) {
		this(null, simpleDateTimeFormat);
	}

	public AbleObjectMapper(ApplicationContext applicationContext, String simpleDateTimeFormat) {
