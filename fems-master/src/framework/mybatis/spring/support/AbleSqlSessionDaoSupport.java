package framework.mybatis.spring.support;
 ...
 *
 */
public class AbleSqlSessionDaoSupport implements InitializingBean {
	...
	public static String getCurrentMethodName() {
		...
		for (StackTraceElement stack : stacks) {
			if("java.lang.Thread".equals(stack.getClassName()) && ("getStackTraceImpl".equals(stack.getMethodName()) || "getStackTrace".equals(stack.getMethodName()))) {
				continue;
			}
			if(depth == 1) {
		...
		throw new AbleRuntimeException("#### FAILED to getCurrentMethodName ####");
