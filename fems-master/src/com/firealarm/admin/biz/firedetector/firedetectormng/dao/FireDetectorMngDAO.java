package com.firealarm.admin.biz.firedetector.firedetectormng.dao;
 ...
 */
@Repository
public class FireDetectorMngDAO extends DAOSupport {

	/** 전체 목록 조회 */
	public List<FireDetectorMngVO> getListAll(Sort sort, SearchMap search) {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("sort", prepareSortParameter(sort, FireDetectorMngVO.class));
		param.put("search", search);
		param.put("me", UserSecurityUtil.getCurrentUserDetails());
		List<FireDetectorMngVO> list = sqlSession.selectList(mapperNamespace + AbleUtil.getCurrentMethodName(), param);
		return list;
	}
	...
	public Page<FireDetectorMngVO> getList(Pageable pageable, SearchMap search) {
		...
		param.put("sort", prepareSortParameter(pageableToApply.getSort(), FireDetectorMngVO.class));
		List<FireDetectorMngVO> list = sqlSession.selectList(mapperNamespace + AbleUtil.getCurrentMethodName() + "Page", param);
		Page<FireDetectorMngVO> page = new PageImpl<FireDetectorMngVO>(list, pageableToApply, total);
		return page;
	}
	...
	/** 화재감지기 등록 */
	public long insert(FireDetectorMngActiveVO vo) {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("vo", vo);
	...
	/** 화재감지기 수정 */
	public int update(FireDetectorMngActiveVO vo) {
		Map<String, Object> param = new HashMap<String, Object>();
		param.put("vo", vo);
