...
@RequestMapping(value = "/firedetector/firedetectormng")
public class FireDetectorMngController extends MngAreaControllerSupport {
	...
	public String index(Model model, @AppLoginUser AppUserDetails me) {
		...
		return "firedetector/firedetectormng/firedetectormng";
	}
	...
	public View excelDownload(
		...
		List<FireDetectorMngVO> list = fireDetectorMngService.getListAll(sort, search);
		AbleExcelCommand command = new AbleExcelCommand(list, FireDetectorMngVO.class, messageSource);
