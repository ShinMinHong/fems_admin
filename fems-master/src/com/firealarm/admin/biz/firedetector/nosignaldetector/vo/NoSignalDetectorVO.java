package com.firealarm.admin.biz.firedetector.nosignaldetector.vo;
...
@Data
public class NoSignalDetectorVO {
	...
	/** 등록일시 */
	@JsonView({BaseView.class})
	@ExcelColumn(name="등록일시", order=40)
	...
	/** 최종수집일 */
	@JsonView({BaseView.class})
	@ExcelColumn(name="최종수집일", order=41)
	private LocalDateTime lastUpdtDt;

	/** 배터리2잔량(%) */
	@JsonView({BaseView.class})
	@ExcelColumn(name="3.6V 배터리(%)", order=39)
